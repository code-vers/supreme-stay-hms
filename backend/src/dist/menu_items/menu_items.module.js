...
exports.MenuItemModule = MenuItemModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([menu_item_entity_1.MenuItem, restaurant_entity_1.Restaurant])],
        controllers: [menu_items_controller_1.MenuItemController],
        providers: [menu_items_service_1.MenuItemService],
    })
], MenuItemModule);
